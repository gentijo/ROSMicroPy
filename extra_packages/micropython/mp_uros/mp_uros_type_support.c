...
ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_EXPORT_mpy_uros_msgs
static uint32_t mpy_uros_typesupport_get_initial_serialized_size(const void * untyped_ros_message)
{
  return (uint32_t)(
    get_serialized_size_mp_uros_type(untyped_ros_message, 0));
}

size_t mpy_uros_typesupport_max_serialized_size(bool * full_bounded, size_t current_alignment)
{
...
static message_type_support_callbacks_t callbacks_mpy_uros_type_support = {
  "micropython",
  "object",
  ...
  mpy_uros_typesupport_max_serialized_size
};

static rosidl_message_type_support_t mpy_uros_type_support = {
